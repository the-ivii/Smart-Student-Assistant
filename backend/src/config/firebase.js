...
// Priority 1: Use environment variables (REQUIRED for deployment - Render, Vercel, Railway, etc.)
...
// Priority 2: Try to read from JSON file path (ONLY for local development, NOT in production)
